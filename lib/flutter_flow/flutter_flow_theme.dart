...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFC39E71);
  late Color secondary = const Color(0xFF3E362F);
  late Color tertiary = const Color(0xFFBCB39E);
  late Color alternate = const Color(0xFFE8E4DF);
  late Color primaryText = const Color(0xFF16120D);
  late Color secondaryText = const Color(0xFF6B635B);
  late Color primaryBackground = const Color(0xFFF9F8F6);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFD0AD8A);
  ...
  late Color hint = const Color(0xFFBCB39E);
  late Color divider = const Color(0xFFE8E4DF);
  late Color outline = const Color(0xFFE8E4DF);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD0AD8A);
  late Color secondary = const Color(0xFFC4C0B9);
  late Color tertiary = const Color(0xFF6B635B);
  late Color alternate = const Color(0xFF3E362F);
  late Color primaryText = const Color(0xFFF9F8F6);
  late Color secondaryText = const Color(0xFFBCB39E);
  late Color primaryBackground = const Color(0xFF16120D);
  late Color secondaryBackground = const Color(0xFF25211D);
  late Color accent1 = const Color(0xFFB58E63);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xB2262D34);
  late Color success = const Color(0xFF98FB98);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF6B6B);
  late Color info = const Color(0xFFFFFFFF);

  late Color hint = const Color(0xFF6B635B);
  late Color divider = const Color(0xFF3E362F);
  late Color outline = const Color(0xFF3E362F);
}
...
class FFShadows {
  ...
  BoxShadow get sm => const BoxShadow(
      blurRadius: 2.0,
      color: const Color(0x0D16120D),
      offset: const Offset(0.0, 1.0),
      spreadRadius: 0.0);
  BoxShadow get md => const BoxShadow(
      blurRadius: 8.0,
      color: const Color(0x1416120D),
      offset: const Offset(0.0, 4.0),
      spreadRadius: 0.0);
  BoxShadow get lg => const BoxShadow(
      blurRadius: 16.0,
      color: const Color(0x1A16120D),
      offset: const Offset(0.0, 8.0),
      spreadRadius: 0.0);
  BoxShadow get xl => const BoxShadow(
      blurRadius: 24.0,
      color: const Color(0x2616120D),
